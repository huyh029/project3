...
const playerSchema = new Schema(
  {
    ...
    rank: { type: String, default: "Dong 5 - 0*" },
    rankTier: {
      type: String,
      enum: ["bronze", "silver", "gold", "diamond", "elite", "master"],
      default: "bronze",
    },
    rankDivision: { type: Number, default: 5 },
    rankStars: { type: Number, default: 0 },
    rankEssence: { type: Number, default: 0 },
